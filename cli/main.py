...
def get_user_selections():
    ...
    if provider_from_env:
        ...
        if selected_llm_provider in ("custom", "custom_openai") and backend_url:
            try:
        ...
        # For Ollama / LM Studio, surface the resolved endpoint before model selection so it's obvious where we're connecting.
        if selected_llm_provider == "ollama":
            confirm_ollama_endpoint(backend_url)
        elif selected_llm_provider in ("lmstudio", "lm-studio") and backend_url:
